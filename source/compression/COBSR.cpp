...
//
//int encode(byte[] buffer, int size, byte[] encoded) {
//     cobsr_encode_result result = cobsr_encode(encoded, encoded.length, buffer, size);
//     return result.out_len;
//}
//
//
//int decode(byte[] buffer, int size, byte[] decoded) {
//    cobsr_decode_result result = cobsr_decode(decoded, decoded.length, buffer, size);
//    return result.out_len;
//}
//
//
//int getEncodedBufferSize(int sourceSize) {
