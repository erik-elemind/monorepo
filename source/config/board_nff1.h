...
#define USART_BLE_RTOS_HANDLE    FLEXCOMM0_rtos_handle // Declared and init'd in peripherals.c
 ...
 * DEBUG UART
 *****************************************************************************/
#define USART_DEBUG_RTOS_HANDLE    FLEXCOMM1_rtos_handle  // Declared and init'd in peripherals.c
...
#define USART_DEBUG_RTOS_HANDLE    FLEXCOMM1_rtos_handle
...
#define SPI_EEG_NVIC_PRIORITY  3     // Interrupt priority: 1 is highest priority
extern spi_rtos_handle_t         SPI_EEG_RTOS_HANDLE;
#endif

#define SPI_EEG_BASE          FLEXCOMM2_PERIPHERAL // Declared and init'd in peripherals.c
#define SPI_EEG_DMA_HANDLE    FLEXCOMM2_DMA_Handle // Declared and init'd in peripherals.c
extern spi_dma_handle_t SPI_EEG_DMA_HANDLE;
void BOARD_InitEEGSPI();



#define SPI_FLASH_BASE         FLEXCOMM3_PERIPHERAL // Declared and init'd in peripherals.c
#define SPI_FLASH_DMA_HANDLE   FLEXCOMM3_DMA_Handle // Declared and init'd in peripherals.c
#define SPI_DMA_TX_HANDLE      FLEXCOMM3_RX_Handle
#define SPI_DMA_RX_HANDLE      FLEXCOMM3_TX_Handle
...
#define SCTIMER_OUT_RED_LED    SCT0_pwmSignalsConfig[0].output
#define SCTIMER_OUT_GRN_LED    SCT0_pwmSignalsConfig[1].output
#define SCTIMER_OUT_BLU_LED    SCT0_pwmSignalsConfig[2].output
#define RED_LED_TRUE_PWM_LEVEL SCT0_pwmSignalsConfig[0].level
#define GRN_LED_TRUE_PWM_LEVEL SCT0_pwmSignalsConfig[1].level
#define BLU_LED_TRUE_PWM_LEVEL SCT0_pwmSignalsConfig[2].level
...
#define POWER_BUTTON_PORT     BOARD_INITPINS_USER_BUTTON2_PORT
#define POWER_BUTTON_PIN      BOARD_INITPINS_USER_BUTTON2_PIN
