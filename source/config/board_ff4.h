...
#define SCTIMER_OUT_RED_LED    SCT0_pwmSignalsConfig[2].output
#define SCTIMER_OUT_GRN_LED    SCT0_pwmSignalsConfig[1].output
#define SCTIMER_OUT_BLU_LED    SCT0_pwmSignalsConfig[0].output
#define RED_LED_TRUE_PWM_LEVEL SCT0_pwmSignalsConfig[2].level
#define GRN_LED_TRUE_PWM_LEVEL SCT0_pwmSignalsConfig[1].level
#define BLU_LED_TRUE_PWM_LEVEL SCT0_pwmSignalsConfig[0].level
 ...
 */
#define LED_PERIPHERAL        SCT0_PERIPHERAL
#define LED_pwmEvent          SCT0_pwmEvent
#define LED_initConfig        SCT0_initConfig
