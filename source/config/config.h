...
#ifndef BUILD_CONFIG
  #error "BUILD_CONFIG not defined in config.h."
#elif (BUILD_CONFIG==BUILD_CONFIG_SLEEP_STUDY_3)
  #if !defined(VARIANT_FF2) && !defined(VARIANT_FF3)
  #error "Sleep Study 3 must run on FF2 or FF3, but neither is defined."
  #endif
#elif (BUILD_CONFIG==BUILD_CONFIG_BETA_1)
  #ifndef VARIANT_FF3
  #error "Beta 1 must run on FF3, but FF3 is undefined."
  #endif
#else
