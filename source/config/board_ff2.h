...
#define SPI_FLASH_BASE         FC3_FLASH_SPI_PERIPHERAL // Declared and init'd in peripherals.c
#define SPI_FLASH_DMA_HANDLE   FC3_FLASH_SPI_DMA_Handle // Declared and init'd in peripherals.c
#define SPI_DMA_TX_HANDLE      FC3_FLASH_SPI_RX_Handle
#define SPI_DMA_RX_HANDLE      FC3_FLASH_SPI_TX_Handle
...
#define I2C4_RTOS_HANDLE      FC4_I2C_rtosHandle
...
#define AUDIO_I2S_BASE          FC7_AUDIO_I2S_PERIPHERAL
#define AUDIO_I2S_TX_HANDLE     FC7_AUDIO_I2S_TX_Handle
#define AUDIO_I2S_DMA_TX_HANDLE FC7_AUDIO_I2S_Tx_DMA_Handle
...
#define SCTIMER_OUT_RED_LED    SCT0_LED_pwmSignalsConfig[0].output
#define SCTIMER_OUT_GRN_LED    SCT0_LED_pwmSignalsConfig[1].output
#define SCTIMER_OUT_BLU_LED    SCT0_LED_pwmSignalsConfig[2].output
#define RED_LED_TRUE_PWM_LEVEL SCT0_LED_pwmSignalsConfig[0].level
#define GRN_LED_TRUE_PWM_LEVEL SCT0_LED_pwmSignalsConfig[1].level
#define BLU_LED_TRUE_PWM_LEVEL SCT0_LED_pwmSignalsConfig[2].level
#define RED_LED_EVENT          0
#define GRN_LED_EVENT          1
#define BLU_LED_EVENT          2
