...
#include "fsl_i2c.h"
//#include "fsl_i2c_freertos.h" //ToDo port

#include "fsl_usart.h"
//#include "fsl_usart_freertos.h" //ToDo port

#include "clock_config.h"
#include "fsl_common.h"
#include "fsl_reset.h"
#include "fsl_gpio.h"
//#include "fsl_iocon.h" //ToDo port

//
// Board-specific Configuration Values (for build time)
//
//#include "clock_config.h" //ToDo port
//#include "peripherals.h" //ToDo port
//#include "pin_mux.h" //ToDo port
//#include "variants/common/RTE_Device.h" //ToDo port
//#include "variants/common/tzm_config.h" //ToDo port
