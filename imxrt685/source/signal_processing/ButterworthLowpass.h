...
#ifndef _BUTTERWORTH_LOWPASS_H_
#define _BUTTERWORTH_LOWPASS_H_
...
class ButterworthLowpass{
  ...
  public:
    ButterworthLowpass(int order, double cutFreq, double sampleFreq){
      ButterworthLowpass();
      design(order,cutFreq,sampleFreq);
    }
    ButterworthLowpass(): index_(0), numcof_(0){
    }
    ~ButterworthLowpass(){
    }
    void reset(){
    ...
    void design(int order, double cutFreq, double sampleFreq, bool resetCache){
      ...
      dcof_bwlp( order, fcf, dbwhp_rcof_, dbwhp_dcof_ );
      ccof_bwlp( order, cbwhp_ccof_);
      double sf = sf_bwlp( order, fcf );
...
class ButterworthLowpassFreq : public ButterworthLowpass<T,MAX_BB_ORDER_T>{
  protected:
  ...
  public:
    ButterworthLowpassFreq() : ButterworthLowpass<T,MAX_BB_ORDER_T>(){
    }
    ~ButterworthLowpassFreq(){
    }
