...
/**********************************************************************
  ...
  a  -  Pointer to a pre-allocated array of doubles of length 2n,
        used to store the returned a[i] coefficients.
*/
...
/**********************************************************************
  ...
  a  -  Pointer to a pre-allocated array of doubles of length 4n,
        used to store the returned a[i] coefficients.
*/
...
/**********************************************************************
  ...
  rconf  -  Pointer to a pre-allocated array of doubles of length 2n.
  dconf  -  Pointer to a pre-allocated array of doubles of length 2n,
            used to store the returned d coefficients.
*/
...
double *dcof_bwlp( int n, double fcf, double* rcof, double* dcof )
{
  ...
  memset(rcof,0,2*n*sizeof(double));
  ...
  dcof = binomial_mult( n, rcof, dcof );
  //free( rcof );
...
{
  return ( dcof_bwlp( n, fcf, rcof, dcof ) );
}
...
/**********************************************************************
  ...
  rconf  -  Pointer to a pre-allocated array of doubles of length 2n.
  tconf  -  Pointer to a pre-allocated array of doubles of length 2n,
  dconf  -  Pointer to a pre-allocated array of doubles of length 4n,
            used to store the returned d coefficients.
*/
...
double *dcof_bwbp( int n, double f1f, double f2f, double* rcof, double* tcof, double* dcof )
{
  ...
  memset(rcof,0,2*n*sizeof(double));
  memset(tcof,0,2*n*sizeof(double));
  ...
  dcof = trinomial_mult( n, tcof, rcof, dcof );
  //free( tcof );
  //free( rcof );
...
/**********************************************************************
  ...
  ccof  -  Pointer to a pre-allocated array of ints of length n+1,
           used to store the returned coefficients.
*/
...
double *ccof_bwlp( int n, double* ccof )
{
  ...
  memset(ccof,0,(n+1)*sizeof(double));
...
/**********************************************************************
  ...
  tcof  -  Pointer to a pre-allocated array of ints of length n+1.
  ccof  -  Pointer to a pre-allocated array of ints of length 2n+1,
           used to store the returned coefficients.
...
double *ccof_bwbp( int n, double* tcof, double* ccof)
{
  ...
  memset(ccof,0,(2*n+1)*sizeof(double));
  if ( ccof == NULL ) return ( NULL );

  tcof = ccof_bwhp(n, tcof);
...
/**********************************************************************
  ...
  ccof  -  Pointer to a pre-allocated array of doubles of length 2n+1,
           used to store the returned coefficients.
*/
