...
SET WORKSPACE_PATH=C:\Users\Erik\Documents\work\m33_workspaces\developer
...
"%IDE%" -nosplash --launcher.suppressErrors -application org.eclipse.cdt.managedbuilder.core.headlessbuild -data %WORKSPACE_PATH% -build morpheus_fw_imxrt685/Debug
