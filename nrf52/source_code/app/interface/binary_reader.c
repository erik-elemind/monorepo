...
// TODO: FIX ENDIAN LOGIC. It doesn't matter whether this processor is big or little endian.
// What matters is that the sending and receiving processors have DIFFERENT endianess.
