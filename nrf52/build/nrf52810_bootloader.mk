# Common makefile for 52810 bootloader builds
...
LINKER_SCRIPT ?= ../nrf52810_bootloader.ld
...
APP_HEX := $(OUTPUT_DIRECTORY)/nrf52810_xxaa_s112.hex
# Named output
...
flash: default
	...
	../flash.sh -f $(APP_HEX) -d NRF52811_XXAA
...
package: default
	...
	nrfutil pkg generate --hw-version 52 --bootloader-version 1 \
		...
		--bootloader $(OUTPUT_DIRECTORY)/nrf52810_xxaa_s112.hex \
